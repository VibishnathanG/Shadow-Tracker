        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex-1 space-y-1">
            ...
            <select
              ...
              className="w-full bg-secondary text-foreground font-black text-base py-2 px-3 rounded-xl border border-border/60 text-center outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 cursor-pointer appearance-none"
            >
